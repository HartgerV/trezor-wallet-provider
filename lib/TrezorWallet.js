...
function () {
  ...
  _createClass(TrezorWallet, [{
    ...
    value: function _handleEvents() {
      ...
      this.deviceList.on('transport', function () {
        return _this.eventEmitter.emit('TREZOR_TRASNPORT_INITIALIZED');
      });
      this.deviceList.on('error', function (error) {
        return _this.eventEmitter.emit('TREZOR_IS_CONNECTED', error);
      });
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                _context.next = 9;
                return this.deviceList.acquireFirstDevice(true);
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee3(callback) {
        var session, addressN, result, chainCode, publicKey, hdk, pathBase, wallets, i, index, dkey, address;
