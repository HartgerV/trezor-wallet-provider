...
export default class TrezorWallet {
  ...
  async signTransactionAsync(txData) {
    return new Promise((resolve, reject) => {
      ...
      TrezorConnect.ethereumSignTx(this.path, TrezorWallet.makeHexEven(txData.nonce), TrezorWallet.makeHexEven(txData.gasPrice), TrezorWallet.makeHexEven(txData.gas), TrezorWallet.makeHexEven(txData.to), TrezorWallet.makeHexEven(txData.value), TrezorWallet.makeHexEven(txData.data), this.networkId, r => {
        console.log(r);
        if (r.success) {
